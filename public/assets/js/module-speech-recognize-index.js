 ...
 *
 */
var idUrl = 'module-speech-recognize';
var idForm = 'module-speech-recognize-form';
var className = 'ModuleSpeechRecognize';
var inputClassName = 'mikopbx-module-input';

/* global globalRootUrl, globalTranslate, Form, Config */
var ModuleSpeechRecognize = {
  $formObj: $('#' + idForm),
  ...
  changeStatus: function changeStatus(status) {
    switch (status) {
      ...
      case 'Updating':
        window[className].$moduleStatus.removeClass('green').removeClass('red').addClass('grey');
        window[className].$moduleStatus.html("<i class=\"spinner loading icon\"></i>".concat(globalTranslate.module_speech_recognizeUpdateStatus));
        break;
      default:
        window[className].$moduleStatus.removeClass('green').removeClass('red').addClass('grey');
        window[className].$moduleStatus.html(globalTranslate.module_speech_recognizeDisconnected);
...
//# sourceMappingURL=module-speech-recognize-index.js.map