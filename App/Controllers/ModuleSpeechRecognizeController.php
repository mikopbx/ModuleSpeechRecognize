 ...
 */
namespace Modules\ModuleSpeechRecognize\App\Controllers;
...
{
    private $moduleUniqueID = 'ModuleSpeechRecognize';
    private $moduleDir;
    ...
    public function indexAction(): void
    {
        ...
        $footerCollection->addJs("js/cache/{$this->moduleUniqueID}/module-speech-recognize-index.js", true);
    ...
    private function getClassName($tableName):string
    {
        ...
        $className = "Modules\ModuleSpeechRecognize\Models\\$tableName";
